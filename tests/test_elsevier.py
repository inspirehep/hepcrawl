...
def test_get_authors(authors):
    assert authors
    assert authors == [{'orcid': 'ORCID:1234-5678-4321-8765', 'affiliations': [{'value': u'Department of Physics'}, {'value': u'Research Center for Advanced Science'}], 'collaborations': [u'The Serious Science Collaboration'], 'surname': u'Scientist', 'given_names': u'Physical'}, {'collaborations': [u'The Serious Science Collaboration'], 'affiliations': [{'value': u'Department of Astronomy'}, {'value': u'Research Center for Advanced Science'}], 'surname': u'Doctor', 'given_names': u'Philosophical', 'email': u'author.email@address.com'}, {'collaborations': [u'Not So Serious Collaboration'], 'affiliations': [{'value': u'Super Cool University, Coolstadt'}], 'surname': u'Random', 'given_names': u'Guy'}]


# Begin testing references:
@pytest.fixture
def ref_textref():
...
def test_ref_textref_sublabels(ref_textref_sublabels):
    ...
    assert ref_textref_sublabels == [
        {'raw_reference': u'D. Kastor, E. Martinec and Z. Qiu, E. Fermi Institute preprint EFI-87-58.', 'label': u'x3a'}, {'raw_reference': u'G. Moore and N. Seiberg, unpublished.', 'label': u'x3b'}
        ]
...
def handled_package(handled_feed):
    ...
    return (spider.handle_package(astropart),
